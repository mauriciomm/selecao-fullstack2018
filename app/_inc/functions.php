...
function getBotaoAplicarVacina($id = 'p__btn_adicionar') {
    $form = new GForm();
    return $form->addButton($id, '<i class="fa fa-medkit"></i> <span class="hidden-phone">Aplicar Vacina</span>', array('class' => 'btn sepH_a sepV_a blue-steel pull-left'));
}
