...
$htmlForm .= $form->addInput('text', 'pro_var_email', 'Email*', array('maxlength' => '50', 'validate' => 'required'));
$htmlForm .= $form->addInput('text', 'pro_var_telefone', 'Telefone*', array('maxlength' => '50', 'validate' => 'required'));
